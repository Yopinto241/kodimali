...
_localizedStrings = <String, Map<String, String>>{
  "en": <String, String>{
    ...
    "location.chooseMethod": "How should KODIMALI find nearby listings?",
    "location.gpsHelp":
        "Use your phone location automatically after permission is granted.",
    "location.manualHelp":
        "Select the correct region, district, ward, or area yourself.",
    "exit.title": "Exit KODIMALI?",
    "exit.body": "Are you sure you want to close the app?",
    "exit.stay": "Stay",
    "exit.confirm": "Exit",
  ...
  "sw": <String, String>{
    ...
    "location.choose": "Chagua mahali",
    "location.chooseMethod":
        "KODIMALI itafute listings za karibu kwa njia gani?",
    "location.gpsHelp": "Tumia eneo la simu kiotomatiki baada ya kuruhusu.",
    "location.manualHelp": "Chagua mwenyewe mkoa, wilaya, kata au eneo sahihi.",
    "exit.title": "Ufunge KODIMALI?",
    "exit.body": "Una uhakika unataka kufunga app?",
    "exit.stay": "Baki",
    "exit.confirm": "Funga",
